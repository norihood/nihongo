(function($) {
    ...
    function initScript() {
        ...
        // validating login form request
        wpcrlValidateAndProcessChangePassForm();

    }

    // Validate login form
    // @author PhuongNLT
    function wpcrlValidateAndProcessChangePassForm() {
        $('#wpcrlChangePassForm').formValidation({
            ...
            var $changePassForm = $(e.target);
            // and the FormValidation instance
            var fv = $changePassForm.data('formValidation');
            var content = $changePassForm.serialize();

            // start processing
            $('#wpcrl-login-loader-info').show();
            wpcrlChangePassFormProcess(content);
    ...
    // @author PhuongNLT
    function wpcrlChangePassFormProcess(content) {

        var loginRequest = jQuery.ajax({
            type: 'POST',
            url: ajaxPostUrl,
            data: content + '&action=wpcrl_user_change_pass',
            dataType: 'json',
            success: function(data) {
                ...
                if (true == data.status) {
                    ...
                    $('#wpcrlChangePassForm .form-group, #wpcrlChangePassForm .btn').hide();
